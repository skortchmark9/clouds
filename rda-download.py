...
filelist = [
  ...
  # GPH
  'https://data.rda.ucar.edu/d612000/CTRL3D/2000/wrf3d_d01_CTRL_Z_20001001.nc',
  'https://data.rda.ucar.edu/d612000/CTRL3D/2000/wrf3d_d01_CTRL_Z_20001002.nc',
  # fill out the rest of these through 31
] + [
  # Heights are stored in separate files for each day
...
def batch_download_parallel(filelist, batch_size=5, delay=2):
    ...
    with ThreadPoolExecutor(max_workers=batch_size) as executor:
        ...
        for i, future in enumerate(as_completed(futures), 1):
            future.result()
            if i % batch_size == 0:
                print(f"Batch {i // batch_size} complete. Waiting {delay} seconds before next batch.")
                time.sleep(delay)
